...
class GeoCLIP3(nn.Module):
    def __init__(self, from_pretrained=True, vision_backbone='CLIP', temporal_aggregation=False, queue_size=4096, gallery_file=None, n_frames=1):
        super().__init__()
        ...
        if vision_backbone == 'CLIP':
            ...
            self.image_encoder = DINOCLIPEncoder2(n_frames=n_frames, temporal_aggregation=temporal_aggregation)
    ...
    #def forward(self, image, location):
        ...
        try:
            ...
            print(image_features.shape, location_features.shape)
            raise e
