...
class TransformerEmbModel(nn.Module):
    ...
    def forward(self, x, video_masks=None):
        # print("DINOCLIPEncoder2_temp")
        batch_size, num_steps, c = x.shape
        #print(batch_size, num_steps, c)
        x = x.reshape(batch_size*num_steps, c)
        ...
        # print("DINOCLIPEncoder2_before_pos")
...
class ImageEncoder2(nn.Module):
    def __init__(self, n_frames=1):
        ...
        self.temp_embed = TransformerEmbModel(num_frames_pe = 32, drop_rate_pe = 0, drop_rate = 0.1, in_channels = 768, cap_scalar = 2, fc_params = [(256, True),(256, True),], embedding_size = 768, 
        hidden_channels = 768, embedder_layers = 2, embedder_heads = 8, embedder_d_ff = 768)
...
class DINOEncoder2(nn.Module):
    def __init__(self, n_frames=1):
        ...
        self.temp_embed = TransformerEmbModel(num_frames_pe = 32, drop_rate_pe = 0, drop_rate = 0.1, in_channels = 1024, cap_scalar = 2, fc_params = [(256, True),(256, True),], embedding_size = 1024, 
        hidden_channels = 1024, embedder_layers = 2, embedder_heads = 8, embedder_d_ff = 1024)        
...
class DINOCLIPEncoder2(nn.Module):
    def __init__(self, n_frames=1):
        ...
        self.temp_embed = TransformerEmbModel(num_frames_pe = 32, drop_rate_pe = 0, drop_rate = 0.1, in_channels = 1792, cap_scalar = 2, fc_params = [(256, True),(256, True),], embedding_size = 1792, 
        hidden_channels = 1792, embedder_layers = 2, embedder_heads = 8, embedder_d_ff = 1792)        
